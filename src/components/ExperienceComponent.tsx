...
export function ExperienceBadge({
  ...
  if (variant === "stamp") {
    ...
    return (
      <div
        className={cn(
          "relative mx-auto flex h-32 max-h-32 w-48 items-center justify-center",
          className,
        )}
      >
        <svg
  ...
  if (variant === "certificate") {
    ...
    return (
      <div
        className={cn(
          "relative z-0",
          "flex flex-col items-center justify-center rounded-xl p-2 w-96",
          "overflow-hidden",
          className,
        )}
      >
        <div className="bg-muted z-10 w-96 rounded-sm border p-6 px-8 text-center">
          <Badge />
          <h1
            className={cn(
              "mt-4 grid text-3xl leading-7 font-bold tracking-tighter uppercase mb-2",
            )}
          >
            {title}
          </h1>
          ...
          <div className={cn("mt-2 text-xs")}>{date}</div>
        </div>
      </div>
    );
  }
    ...
    return (
      ...
      >
        <div className="relative text-center">
          <span
            className="absolute hidden text-4xl font-black tracking-tighter dark:block"
            style={{
          ...
          <span
            className="absolute block text-4xl font-black tracking-tighter dark:hidden"
            style={{
              transform: "translate(4px, 4px)",
          ...
          <span
            className="text-chart-4 absolute hidden text-4xl font-black tracking-tighter dark:block"
            style={{
          ...
          <span
            className="text-primary absolute block text-4xl font-black tracking-tighter dark:hidden"
            style={{
          ...
          <span
            className="text-chart-2 relative text-4xl font-black tracking-tighter"
            style={{
