...
export type AwardBadgeType = "golden" | "silver" | "bronze" | "design";
...
const title = {
  golden: "Golden Kitty Awards",
  silver: "Product of the Day",
  bronze: "Product of the Month",
  design: "Product of the Week",
};
...
export const AwardBadge = ({
  ...
  return (
    <a
      ...
      href={link}
      target="_blank"
      className="block w-[120px] sm:w-[200px] h-auto cursor-pointer"
